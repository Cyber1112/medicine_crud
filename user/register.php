...
include('../api/functions/register.php');
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <form action="" method="POST">
                      ...
                      <div class="form-row">
                          <div class="col-lg-7">
                              <input type="text" name="first_name" placeholder="First Name" class="form-control my-3 p-3" required>
                          </div>
                      </div>
                      <div class="form-row">
                          <div class="col-lg-7">
                              <input type="text" name="last_name" placeholder="Last Name" class="form-control my-3 p-3" required>
                          </div>
                      </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="password" name="confirm_password" placeholder="Re-type Password" class="form-control my-3 p-3" required>
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="col-lg-7">
                                <button type="sumbit" name="register_btn" class="btn1 mt-3 mb-5">SIGN UP</button>
                            </div>
                        </div>
